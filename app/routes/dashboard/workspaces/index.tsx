...
import { WorkspaceAvator } from "@/components/workspace/workspace-avatar";
import type { Workspace } from "@/types/intex";
        ...
        <CardHeader className="pb-2">
          <div className="flex items-center justify-between">
            <div className="flex gap-2">
              <WorkspaceAvator name={workspace.name} color={workspace.color} />
